...
public final class FragmentFriendListBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView recvFriendList;

  @NonNull
  public final SearchView searchView;

  private FragmentFriendListBinding(@NonNull LinearLayout rootView,
      @NonNull RecyclerView recvFriendList, @NonNull SearchView searchView) {
    this.rootView = rootView;
    this.recvFriendList = recvFriendList;
  ...
  public static FragmentFriendListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recv_friend_list;
      RecyclerView recvFriendList = ViewBindings.findChildViewById(rootView, id);
      if (recvFriendList == null) {
        break missingId;
      }
      ...
      return new FragmentFriendListBinding((LinearLayout) rootView, recvFriendList, searchView);
    }
